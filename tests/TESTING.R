for (i in 1:500) {
  ...
  print(i)
  print(all.equal(getInterval(base_tree, nu, splits),getInterval_TEMP(base_tree, nu, splits)))
  print(all.equal(getInterval(base_tree, nu2, splits),getInterval_TEMP(base_tree, nu2, splits)))
}
