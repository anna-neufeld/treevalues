...
#' contains the series of branch "branch".Either base_tree with model=TRUE or X and y must be provided, not both.
#'
...
#' @export
getInterval_full <- function(base_tree, nu, branch,sibs=FALSE) {
...
#' @export
#' @importFrom stats predict
getInterval_prune <- function(base_tree, nu, branch,sibs=FALSE) {
...
#' @return an object of class Interval that defines the set S.
#' @export
getInterval_grow <- function(base_tree, nu, branch, sibs=FALSE) {
