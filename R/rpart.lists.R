#' Creates lists of variable values (factor levels) associated with each rule in an \pkg{rpart} object.  This function was taken from the rpart.utils package, which
