...
library(treevalues)
library(rpart)
load("~/treevalues/data/blsdata.RData")
```
...
```{r}
treeval.plot(bls.tree, pval=FALSE,CI=FALSE)
```
...
```{r}
treeval.plot(bls.tree, pval=TRUE,nn=TRUE)
treeval.plot(bls.tree, pval=TRUE, CI=TRUE, nn=TRUE)
```
